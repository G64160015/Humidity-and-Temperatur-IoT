...
var Topic = 'SensorSuhu3'; 
var device = awsIot.device({
 keyPath: 'cert3/private.pem.key',
 certPath: 'cert3/cer.pem.crt',
 caPath: 'cert3/root.pem',
...
function insert_message(topic, message_str, packet) {
	...
	var params = ['dht21','temperature3','humidity3', temperature, humidity];//dht21 = table name
