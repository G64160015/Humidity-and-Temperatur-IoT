...
var Topic = 'suhudanhumidity1'; 
var device = awsIot.device({
 keyPath: 'cert1/private.pem.key',
 certPath: 'cert1/cer.pem.crt',
 caPath: 'cert1/root.pem',
...
function insert_message(topic, message_str, packet) {
	...
	var params = ['dht21','temperature','humidity', temperature, humidity];//dht21 = table name
